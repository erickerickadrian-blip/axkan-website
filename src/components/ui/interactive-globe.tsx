...
const DEFAULT_MARKERS = [
  ...
  { lat: 25.67, lng: -100.31, label: "Monterrey" },
  { lat: 20.67, lng: -103.35, label: "Guadalajara" },
...
const DEFAULT_CONNECTIONS: { from: [number, number]; to: [number, number] }[] =
  [
    ...
    { from: [19.43, -99.13], to: [40.42, -3.7] },
    { from: [19.43, -99.13], to: [37.78, -122.42] },
    { from: [19.43, -99.13], to: [25.76, -80.19] },
    { from: [25.67, -100.31], to: [19.43, -99.13] },
    { from: [4.71, -74.07], to: [-34.6, -58.38] },
    { from: [-23.55, -46.63], to: [-33.45, -70.67] },
    { from: [20.67, -103.35], to: [19.43, -99.13] },
  ];
...
export function InteractiveGlobe({
  ...
  arcColor = "rgba(56, 189, 248, 0.5)",
  markerColor = "rgba(103, 232, 249, 1)",
